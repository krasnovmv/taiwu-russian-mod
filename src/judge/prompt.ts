...
8. KEEP IT CONCISE. The UI is laid out for English widths; longer Russian is clipped with an ellipsis in-game and text is lost. Aim at or below the English length, never pad, drop nothing meaningful to save space. Over 2.5× the English length is rejected — say it the shorter way.
